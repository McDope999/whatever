...
{
    char testBuffer[] = "AXBY";
    std::cout << "AXBY encoded, trying to send." << std::endl;
    Transport::Transport* Trans = new Transport::Transport((short)BUFSIZE);
    Trans->send(testBuffer, (short)4);
}
